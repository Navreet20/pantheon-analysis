...
def plot_data(throughput_data):
    ...
    plt.title('Throughput Over Time for vegas', fontsize=14)
    plt.grid(True)
    plt.legend()

    # Save the plot as a PNG file instead of showing it
    plt.savefig('vegas_throughput_plot.png', dpi=300, bbox_inches='tight')  # Save as PNG file
...
if __name__ == "__main__":
    log_file_path = '/home/navreet/Desktop/pantheon/output_1mbps/vegas_mm_datalink_run1.log'
